...
export function MicroloansSetupPage({ onSubmit }: SetupPageProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-project-name" className="text-sm font-medium text-gray-700">
          Project Name
        </label>
        <input
          id="mlo-project-name"
          type="text"
          placeholder="e.g. Rural Entrepreneur Loans"
          value={name}
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-location" className="text-sm font-medium text-gray-700">
          Location
        </label>
        <input
          id="mlo-location"
          type="text"
          placeholder="e.g. Karnali Province, Nepal"
          value={location}
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-image" className="text-sm font-medium text-gray-700">
          Image URL
        </label>
        <input
          id="mlo-image"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-start-date" className="text-sm font-medium text-gray-700">
          Start Date
        </label>
        <input
          id="mlo-start-date"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-end-date" className="text-sm font-medium text-gray-700">
          End Date
        </label>
        <input
          id="mlo-end-date"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="mlo-project-owner" className="text-sm font-medium text-gray-700">
          Project Owner
        </label>
        <input
          id="mlo-project-owner"
          type="text"
