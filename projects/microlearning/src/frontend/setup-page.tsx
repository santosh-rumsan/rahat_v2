...
export function MicrolearningSetupPage({ onSubmit }: SetupPageProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-project-name" className="text-sm font-medium text-gray-700">
          Project Name
        </label>
        <input
          id="ml-project-name"
          type="text"
          placeholder="e.g. Financial Literacy Program"
          value={name}
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-location" className="text-sm font-medium text-gray-700">
          Location
        </label>
        <input
          id="ml-location"
          type="text"
          placeholder="e.g. Humla District, Nepal"
          value={location}
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-image" className="text-sm font-medium text-gray-700">
          Image URL
        </label>
        <input
          id="ml-image"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-start-date" className="text-sm font-medium text-gray-700">
          Start Date
        </label>
        <input
          id="ml-start-date"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-end-date" className="text-sm font-medium text-gray-700">
          End Date
        </label>
        <input
          id="ml-end-date"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="ml-project-owner" className="text-sm font-medium text-gray-700">
          Project Owner
        </label>
        <input
          id="ml-project-owner"
